...
const getNativeTokenBalance = async (
  ...
  args: IndexerGateway.GetNativeTokenBalanceRequest
 ...
 * ```
 */
export const useGetNativeTokenBalance = (args: IndexerGateway.GetNativeTokenBalanceRequest, options?: HooksOptions) => {
