...
const getTokenBalancesDetails = async (
  ...
  args: IndexerGateway.GetTokenBalancesDetailsRequest
) => {
  try {
 ...
 * ```
 */
export const useGetTokenBalancesDetails = (args: IndexerGateway.GetTokenBalancesDetailsRequest, options?: HooksOptions) => {
